...
version: "3.0"
updated: "2026-02-07"
description: "Kimi K2 CLI + mux-backend multi-agent parallel dev platform with sengoku military hierarchy"
...
4. **Read your generated instructions file**: shogun→`instructions/generated/kimi-shogun.md`, karo→`instructions/generated/kimi-karo.md`, ashigaru→`instructions/generated/kimi-ashigaru.md`, gunshi→`instructions/generated/kimi-gunshi.md`. **NEVER SKIP** — even if a conversation summary exists. Sources are `instructions/roles/*_role.md`, `instructions/common/*.md`, CLI-specific parts, and legacy entry YAML frontmatter. Legacy entry prose is archived, not a second policy authority.

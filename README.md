...
Agents should start with their CLI's unattended permission bypass. Claude uses `--dangerously-skip-permissions`, and OpenCode uses `OPENCODE_PERMISSION=allow`. This is handled automatically by `shutsujin_departure.sh`.
